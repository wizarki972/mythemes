...
local term = "kitty"
local codeEditor = "codium || code"
local file = "nautilus"
local browser = "helium-browser || zen-browser"
...
hl.bind(mainMod .. " + Return", hl.dsp.window.fullscreen_state({0, 2, action = "toggle"}))
...
hl.bind(mainMod .. " + CTRL + Right", hl.dsp.workspace("r+1"))
hl.bind(mainMod .. " + CTRL + Left", hl.dsp.workspace("r-1"))
-- Move to the first empty workspace
hl.bind(mainMod .. " + CTRL + Down", hl.dsp.workspace("empty"))
...
hl.bind(coPilot .. " + ALT", hl.dsp.window.move({ workspace="special:default" }))
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("~/.config/rofi/bin/launcher"))
